...
<div id="mainDiv" style="width:400px; height:400px;margin:0 auto;margin-top:30px;">
    ...
    <div style="margin:30 159;font-size:20px;">用户注册</div>
    <form class="form-horizontal" role="form" action="userRegister">
        ...
        <div style="margin:10 130;">
            <button type="submit" class="btn btn-primary" style="margin-right:25px;">注册</button>
